...
const Service = ({ number, title, description }) => {
    return (
        <div className="flex items-center justify-center m-8">
            <div className="font-poppins font-bold w-[70px] h-[70px] text-main-red bg-white p-3 mx-3 flex justify-center items-center">
                <p className="whitespace-nowrap"># {number}</p>
            </div>

            <div className="text-white ml-4 text-left w-[65%] ">
